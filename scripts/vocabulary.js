...
export const ELEMENTS = {
  ...
  water: [
    null,
    { arcane: "aqshi",       primal: "sshrr",         occult: "quach",             divine: "undim"        },
    { arcane: "aqshaah",     primal: "sshrr-agh",     occult: "quach'tah",         divine: "undaim"       },
    { arcane: "aqshahr",     primal: "sha=ur",        occult: "quach'tachla",      divine: "undaimnor"    },
    { arcane: "vazaqsh",     primal: "sha-urargh",    occult: "quach'tachsas",     divine: "vastundim"    },
    { arcane: "ahnaqu",      primal: "shragh-thrum",  occult: "quach'sahth'tahs",  divine: "fluminalis"   },
  ],
  cold: [
    null,
    { arcane: "cryssah",     primal: "brruhm",        occult: "mgfmti",           divine: "gelim"        },
    { arcane: "cryssahn",    primal: "brruhzz",       occult: "mgfmti'tah",       divine: "gelaim"       },
    { arcane: "cryssahnir",  primal: "brruhzzom",     occult: "mgfm'tachla",      divine: "gelaimnor"    },
    { arcane: "cryssahnar",  primal: "shrummbr",      occult: "mgfm'tachsas",     divine: "vastgelim"    },
    { arcane: "ahncryssah",  primal: "ommbrrug",      occult: "mgfm'tsahth'tahs", divine: "glacielis"    },
  ],
  electricity: [
    null,
  ...
  vitality: [
    null,
    { arcane: "hyirsh",       primal: "hyumm",         occult: "yang",             divine: "salim"        },
    { arcane: "hyarshaah",    primal: "hyummugh",      occult: "yang'tah",         divine: "salaim"       },
    { arcane: "hyirshahr",    primal: "hyumughfrah",   occult: "yang'tachla",      divine: "salaimnor"    },
    { arcane: "hyazirsha",    primal: "hyimnugh",      occult: "yang'tachsas",     divine: "vastsalim"    },
    { arcane: "hyuzarsh",     primal: "hyimnughfrah",  occult: "yang'sahth'tahs",  divine: "resurrequalis"},
  ],
  mental: [
    null,
    { arcane: "syarshi",      primal: "mmrruu",        occult: "xin",              divine: "mensim"       },
    { arcane: "syarshyah",    primal: "mmrruumm",      occult: "xin'tah",          divine: "mensaim"      },
    { arcane: "syishahr",     primal: "mrrmmurr",      occult: "xin'tachla",       divine: "mensaimnor"   },
    { arcane: "syazshir",     primal: "mrruhmmsh",     occult: "xin'tachsas",      divine: "vastmensim"   },
    { arcane: "syahnsha",     primal: "mrrrummshfrah", occult: "xin'sahth'tahs",   divine: "mentiqualis"  },
  ],
  light: [
    null,
    { arcane: "leuksh",      primal: "shaahmup",      occult: "guang",            divine: "luxim"        },
    { arcane: "leuksha",     primal: "shaahmupum",    occult: "guang'tah",        divine: "luxaim"       },
    { arcane: "lorsha",      primal: "shaahmupfrah",  occult: "guang'tachla",     divine: "luxaimnor"    },
    { arcane: "lorzhan",     primal: "raahmshahm",    occult: "guang'tachsas",    divine: "vastluxim"    },
    { arcane: "inlorleuksh", primal: "raahmshahmfrah",occult: "guang'sahth'tahs", divine: "claritalis"   },
  ],
  darkness: [
    null,
  ...
  sonic: [
    null,
    { arcane: "shiiish",     primal: "huommup",       occult: "sheng",            divine: "sonim"        },
    { arcane: "aashaah",     primal: "huommupum",     occult: "sheng'tah",        divine: "sonaim"       },
    { arcane: "ashaahr",     primal: "rrummomm",      occult: "sheng'tachla",     divine: "sonaimnor"    },
    { arcane: "vaahish",     primal: "rrummommfrah",  occult: "sheng'tachsas",    divine: "vastsonim"    },
    { arcane: "woohshir",    primal: "dahrumummm",    occult: "sheng'sahth'tahs", divine: "resonalis"    },
  ],
  metal: [
    null,
    { arcane: "etang",       primal: "kuhlang",       occult: "jin",              divine: "ferrim"       },
    { arcane: "metang",      primal: "kuhlangor",     occult: "jin'tah",          divine: "feraim"       },
    { arcane: "metangshah",  primal: "kuhlangah",     occult: "jin'tachla",       divine: "feraimnor"    },
    { arcane: "metangvah",   primal: "karashbrrum",   occult: "jin'tachsas",      divine: "vastferrim"   },
    { arcane: "metangvosh",  primal: "karashbang",    occult: "jin'sahth'tahs",   divine: "metallalis"   },
  ],
  wood: [
    null,
    { arcane: "xylshi",      primal: "whoomp",        occult: "mu",               divine: "lignim"       },
    { arcane: "xylshaah",    primal: "whoompkrak",    occult: "mu'tah",           divine: "lignaim"      },
    { arcane: "xylshahr",    primal: "whoompfd",      occult: "mu'tachla",        divine: "lignaimnor"   },
    { arcane: "vazxylsh",    primal: "whoompfdrm",    occult: "mu'tachsas",       divine: "vastlignim"   },
    { arcane: "ahnxylsh",    primal: "grrufmdrak",    occult: "mu'sahth'tahs",    divine: "sylvalis"     },
  ],
  aether: [
    null,
...
export const SIGNATURES = {
  ...
  occult: [
    "p'tah", "f'tah", "s'gin", "m'glaw","ah'gul",
